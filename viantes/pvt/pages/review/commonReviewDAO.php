...
class CommonReviewDAO extends CommonDAO {
	...
	*/
    ...
    public function buildRevStar($revId, $type){
		...
		if ($type == SiteReview) {
			$sql = sprintf("SELECT SI.ID AS PLACEID, SI.SITENAME AS PLACE, U.NAME, R.ID AS REVID, STAR, SEE, POST, U.ID, U.COVERFILENAME
							FROM REVIEW R
			...
			$sql = sprintf("SELECT CT.ID AS PLACEID, CT.CITYNAME AS PLACE, U.NAME, R.ID AS REVID, STAR, SEE, POST, U.ID, U.COVERFILENAME
							FROM CITY_REVIEW R
			...
			$sql = sprintf("SELECT CN.ID AS PLACEID, CN.COUNTRY, U.NAME, R.ID AS REVID, STAR, SEE, POST, U.ID, U.COVERFILENAME
							FROM COUNTRY_REVIEW R
