...
<form id="attachImgFrm" enctype="multipart/form-data" action="/viantes/pvt/pages/review/create/createCityRev.php" method="POST">
	<?php 
	if (!isset($_GET['finish'])) { ?>
		...
		<input id="attachImgInput" class="hideInputButtonFile" name="userfile" type="file" 
			   onchange="setFieldsAndErrMsgReviewPage(2); $('#submitImg').click();
						 showOverlayForLoad('<?php echo $X_langArray['CREATE_REVIEW_IMG_WAIT_LOAD'] ?>','submitImg')"/> 
	<?php
	} 
	...
	<input id="cityHidden_2"     type="hidden" name="city" value="" />
	...
	<input id="cityErrMsgHidden_2"      type="hidden" name="cityErrMsg" value="" />
