...
<form id="attachMovFrm" enctype="multipart/form-data" action="/viantes/pvt/pages/review/create/createCityRev.php" method="POST">
	<?php 
	...
	<input id="cityHidden_3"     type="hidden" name="city" value="" />
	...
	<input id="cityErrMsgHidden_3"      type="hidden" name="cityErrMsg" value="" />
