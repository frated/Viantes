...
<form action="/viantes/pvt/pages/review/create/createCityRev.php" enctype="multipart/form-data" method="post" >
		...
		<div class="commonRowDiv">
			<label>
				...
				<input id="city" type="text" name="city" style="width: 52%" class="commonRowTxt_col2 
					   ...
					   onkeyup="doFieldAsyncGetMinLen('/viantes/pvt/pages/review/create/createCityRev.php','city', 3);"
					   onblur="hideCartoon('city'); 
					   if($('#cityIgnoreBlur').val() === 'true') { return; }
		...
		<div class="commonRowDiv">
			<label>
				...
				<textarea id="descr" name="descr" class="commonRowArea_col2_1000
						  ...
						  onkeyup="doFieldAsyncGetMinLen('/viantes/pvt/pages/review/create/createCityRev.php','descr', 50);"
	...
	<div class="commonDIVRight">
		<div class="commonRowDiv" style="margin-top: 20px">
			<span id="cityCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_CITY'] ?>
			</span>	
		</div>
		<div class="commonRowDiv" style="margin-top: 428px">	
			<span id="descrCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_REVIEW'] ?>
			</span>
		</div>
		<div class="commonRowDiv" style="margin-top: 622px">
			<span id="arriveCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_ARRIVE'] ?>
			</span>
		</div>		
	</div>
	...
	<div class="commonDIVRight">	
		<div class="commonRowDiv" style="margin-top: 28px">
			<span id="addInterestCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_INTEREST'] ?>
			</span>
		</div>
	</div>	
		...
		<div class="commonRowDiv">
			<label>
				...
				<textarea id="whEat" name="whEat" class="commonRowArea_col2_500 
						  ...
						  onkeyup="doFieldAsyncGetMinLen('/viantes/pvt/pages/review/create/createCityRev.php','whEat', 25);"
		...
		<div class="commonRowDiv">
			<label>
				...
				<textarea id="cook" name="cook" class="commonRowArea_col2_500 
						  ...
						  onkeyup="doFieldAsyncGetMinLen('/viantes/pvt/pages/review/create/createCityRev.php','cook', 25);"
		...
		<div class="commonRowDiv">
			<label>
				...
				<textarea id="whStay" name="whStay" class="commonRowArea_col2_500 
						  ...
						  onkeyup="doFieldAsyncGetMinLen('/viantes/pvt/pages/review/create/createCityRev.php','whStay', 25);"
		...
		<div class="commonRowDiv">
			<label>
				...
				<textarea id="myth" name="myth" class="commonRowArea_col2_250 
					   ...
					   onkeyup="doFieldAsyncGetMinLen('/viantes/pvt/pages/review/create/createCityRev.php','myth', 10);"
	...
	<div class="commonDIVRight">
		<div class="commonRowDiv" style="margin-top: 40px">
			<span id="warnCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_WARN'] ?>
			</span>
		</div>	
		<div class="commonRowDiv" style="margin-top: 140px">
			<span id="whEatCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_EAT'] ?>
			</span>
		</div>	
		<div class="commonRowDiv" style="margin-top: 310px">
			<span id="cookCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_REVIEW_CARTOON_COOK'] ?>
			</span>
		</div>	
		<div class="commonRowDiv" style="margin-top: 450px">
		...
		<div class="commonRowDiv" style="margin-top: 610px;">
			<span id="mythCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_MYTH'] ?>
			</span>	
		</div>	
		<div class="commonRowDiv" style="margin-top: 515px;">
			<span id="voteCartoon" class="inputcartoon">
				<?php echo $X_langArray['CREATE_CITY_CARTOON_VOTE'] ?>
			</span>	
		</div>	
	</div>
